...
import sendx_java_sdk.auth.Authentication;
import sendx_java_sdk.auth.HttpBasicAuth;
import sendx_java_sdk.auth.HttpBearerAuth;
import sendx_java_sdk.auth.ApiKeyAuth;
...
public class ApiClient {
    ...
    private String basePath = "https://api.sendx.io/api/v1/rest";
    ...
    new ServerConfiguration(
      "https://stag.sendx.io/api/v1/rest",
      "Staging server",
      new HashMap<String, ServerVariable>()
    ),
    new ServerConfiguration(
    ...
    public ApiClient() {
        ...
        authentications.put("apiKeyAuth", new ApiKeyAuth("header", "X-Team-ApiKey"));
     ...
     * Set base path
     *
     * @param basePath Base path of the URL (e.g https://api.sendx.io/api/v1/rest
     ...
     * @return a {@link sendx_java_sdk.ApiClient} object
     */
    ...
    */
     ...
     * @throws sendx_java_sdk.ApiException If fail to deserialize response body, i.e. cannot read response body
     ...
     * @throws sendx_java_sdk.ApiException If fail to serialize the given object
     */
     ...
     * @throws sendx_java_sdk.ApiException If fail to read file content from response and write to disk
     ...
     * @throws sendx_java_sdk.ApiException If fail to execute the call
     */
     ...
     * @param returnType Return type
     * @return Type
     * @throws sendx_java_sdk.ApiException If the response has an unsuccessful status code or
     ...
     * @throws sendx_java_sdk.ApiException If fail to serialize the request body object
     */
     ...
     * @param uri URI
     * @throws sendx_java_sdk.ApiException If fails to update the parameters
     */
     ...
     * @throws sendx_java_sdk.ApiException If fail to serialize the request body object into a string
     */
