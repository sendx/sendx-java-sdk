...
public class JSON {
    ...
    static {
        ...
        gsonBuilder.registerTypeAdapterFactory(new sendx_java_sdk.Campaign.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sendx_java_sdk.CampaignDashboardData.CustomTypeAdapterFactory());
        gsonBuilder.registerTypeAdapterFactory(new sendx_java_sdk.CampaignRequest.CustomTypeAdapterFactory());
